...
@ManagedBean
@RequestScoped
public class TarjetaConverter implements Converter, Serializable {

	private static final long serialVersionUID = 1L;
	
	private Logger logger = LoggerFactory.getLogger(TarjetaConverter.class);
	...
	public Object getAsObject(FacesContext context, UIComponent component, String value) {
		...
		try {
			...
			Tarjeta entity = dao.findById(id);
