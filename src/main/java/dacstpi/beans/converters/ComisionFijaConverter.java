...
@ManagedBean
@RequestScoped
public class ComisionFijaConverter implements Converter, Serializable {

	private static final long serialVersionUID = 1L;
	
	private Logger logger = LoggerFactory.getLogger(ComisionFijaConverter.class);
	
	// Dependencies -----------------------------------------------------------
	
    @EJB
    private ComisionFijaDao dao;
	...
	public Object getAsObject(FacesContext context, UIComponent component, String value) {
		...
		try {
			...
			ComisionFija entity = dao.findById(id);
	...
	public String getAsString(FacesContext context, UIComponent component, Object value) {
		if (value == null)
			return null;
		try {
			return String.valueOf(((ComisionFija) value).getId());
